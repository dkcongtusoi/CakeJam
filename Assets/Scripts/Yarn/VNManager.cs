...
namespace Yarn.Unity.Example {
    ...
    public class VNManager : DialogueViewBase
    {
		...
		public static bool BeginRun = false;
		...
		List<Markup.MarkupAttribute> markups = new List<Markup.MarkupAttribute>();
		private const string MARKUP_SPEED = "speed";
		private const string MARKUP_CHAR = "char";

		private const float TYPEWRITER_SPEED = 0f;
		...
		void Awake () {
			...
			//runner.AddCommandHandler("begin", Begin);
			//runner.AddCommandHandler("exit", Exit);
